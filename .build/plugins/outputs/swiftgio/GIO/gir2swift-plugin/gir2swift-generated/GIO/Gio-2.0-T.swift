...
public extension ThreadedSocketServiceProtocol {
    ...
    @discardableResult @inlinable func onRun(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ThreadedSocketServiceRef, _ connection: SocketConnectionRef, _ sourceObject: ObjectRef?) -> Bool ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ThreadedSocketServiceRef, SocketConnectionRef, ObjectRef?), Bool>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer?, gpointer) -> gboolean = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output = holder.call((ThreadedSocketServiceRef(raw: unownedSelf), SocketConnectionRef(raw: arg1), arg2.flatMap(ObjectRef.init(raw:))))
    ...
    @discardableResult @inlinable func onNotifyMaxThreads(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ThreadedSocketServiceRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ThreadedSocketServiceRef, ParamSpecRef), Void>
...
public extension TLSConnectionProtocol {
    ...
    @discardableResult @inlinable func onNotifyAdvertisedProtocols(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: TLSConnectionRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(TLSConnectionRef, ParamSpecRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
