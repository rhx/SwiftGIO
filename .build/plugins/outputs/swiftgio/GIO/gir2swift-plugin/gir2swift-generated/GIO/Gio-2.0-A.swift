...
public extension AppLaunchContextProtocol {
    ...
    @discardableResult @inlinable func onLaunched(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: AppLaunchContextRef, _ info: AppInfoRef, _ platformData: VariantRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(AppLaunchContextRef, AppInfoRef, VariantRef), Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((AppLaunchContextRef(raw: unownedSelf), AppInfoRef(raw: arg1), VariantRef(raw: arg2)))
            return output
        }
        return connect(
            signal: .launched,
...
public extension ActionGroupProtocol {
    ...
    @discardableResult @inlinable func onActionStateChanged(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ActionGroupRef, _ actionName: String, _ value: VariantRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ActionGroupRef, String, VariantRef), Void>
        let cCallback: @convention(c) (gpointer, UnsafeMutablePointer<gchar>?, gpointer, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call((ActionGroupRef(raw: unownedSelf), arg1.map({ String(cString: $0) })!, VariantRef(raw: arg2)))
            return output
        }
        return connect(
...
public extension ApplicationProtocol {
    ...
    @discardableResult @inlinable func onHandleLocalOptions(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ApplicationRef, _ options: VariantDictRef) -> Int ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ApplicationRef, VariantDictRef), Int>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> gint = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output = holder.call((ApplicationRef(raw: unownedSelf), VariantDictRef(raw: arg1)))
            return gint(output)
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyActionGroup(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: ApplicationRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder<(ApplicationRef, ParamSpecRef), Void>
...
public extension ApplicationProtocol {
    ...
    @inlinable func addMainOption(longName: UnsafePointer<CChar>!, shortName: CChar, flags: OptionFlags, arg: GOptionArg, description: UnsafePointer<CChar>!, argDescription: UnsafePointer<CChar>? = nil) {
