...
public extension OsxAppInfoRef {
    ...
    @inlinable static func unowned<T: OsxAppInfoProtocol>(_ other: T) -> OsxAppInfoRef { OsxAppInfoRef(other) }
...
// MARK: OsxAppInfo has no signals
...
public extension OsxAppInfoProtocol {
    ...
    @inlinable func getFilename() -> String! {
        let result = g_osx_app_info_get_filename(osx_app_info_ptr)
