...
public extension NetworkMonitorProtocol {
    ...
    @discardableResult @inlinable func onNetworkChanged(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NetworkMonitorRef, _ networkAvailable: Bool) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder2<NetworkMonitorRef, Bool, Void>
    ...
    @discardableResult @inlinable func onNotifyConnectivity(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NetworkMonitorRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder2<NetworkMonitorRef, ParamSpecRef, Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(NetworkMonitorRef(raw: unownedSelf), ParamSpecRef(raw: arg1))
            return output
        }
        return connect(
    ...
    @discardableResult @inlinable func onNotifyNetworkAvailable(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NetworkMonitorRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder2<NetworkMonitorRef, ParamSpecRef, Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(NetworkMonitorRef(raw: unownedSelf), ParamSpecRef(raw: arg1))
    ...
    @discardableResult @inlinable func onNotifyNetworkMetered(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: NetworkMonitorRef, _ pspec: ParamSpecRef) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder2<NetworkMonitorRef, ParamSpecRef, Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer) -> Void = { unownedSelf, arg1, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(NetworkMonitorRef(raw: unownedSelf), ParamSpecRef(raw: arg1))
